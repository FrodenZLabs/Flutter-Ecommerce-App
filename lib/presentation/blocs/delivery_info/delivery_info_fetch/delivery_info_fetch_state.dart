...
class DeliveryInfoFetchInitial extends DeliveryInfoFetchState {
  const DeliveryInfoFetchInitial({required super.deliveryInformation, super.selectedDeliveryInformation});
}

class DeliveryInfoFetchLoading extends DeliveryInfoFetchState {
  const DeliveryInfoFetchLoading({required super.deliveryInformation, super.selectedDeliveryInformation});
}

class DeliveryInfoFetchSuccess extends DeliveryInfoFetchState {
  const DeliveryInfoFetchSuccess({required super.deliveryInformation, super.selectedDeliveryInformation});
}

class DeliveryInfoFetchFail extends DeliveryInfoFetchState {
  const DeliveryInfoFetchFail({required super.deliveryInformation, super.selectedDeliveryInformation});
}