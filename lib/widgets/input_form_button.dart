...
class InputFormButton extends StatelessWidget {
  ...
  const InputFormButton({super.key, required this.onClick, this.titleText, this.icon, this.color, this.cornerRadius, this.padding = const EdgeInsets.symmetric(horizontal: 16)});
  ...
  Widget build(BuildContext context) {
    return ElevatedButton(
        ...
        style: ButtonStyle(
          ...
          maximumSize: WidgetStateProperty.all<Size>(Size(double.maxFinite, 28.0.sp)),
