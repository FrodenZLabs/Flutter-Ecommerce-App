import 'dart:convert';
import 'package:flutter_ecommerce_app/data/models/order/order_item_model.dart';
...
class OrderDetailsModel extends OrderDetails {
  const OrderDetailsModel({required super.id, required super.orderItems, required super.deliveryInfo, required super.discount});
  ...
  factory OrderDetailsModel.fromEntity(OrderDetails entity) => OrderDetailsModel(
    id: entity.id,
